  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className='h-full max-w-xs cursor-pointer rounded-xl bg-white p-6 shadow-md transition hover:bg-slate-200 hover:shadow-lg focus:bg-slate-300 active:bg-slate-300'
      >
